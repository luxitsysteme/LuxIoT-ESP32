...
## Example Code
The code below is a minimal example for using the library with the Lux IoT Cloud. You need to provide a valid certificate in ```cert/root.pem``` and s small addition to your platformio.ini
...
#define API_PROVISION_TOKEN      "<Your Provision ID>" 
