...
class LuxIoT{
public:
    LuxIoT(const String &baseUrl, const String &provisionSuffix, const String &provisionToken, const uint32_t fallbackSleeptime, const uint32_t watchdogTime, HTTPClient &httpClient, void (*beforeSleepCallback)(u_int64_t sleepTime) );
    uint8_t begin();
...
private:
    ...
    void (*mBeforeSleepCallback)(uint64_t sleepTime) ;
};
